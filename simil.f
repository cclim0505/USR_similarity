...
! Similarity subroutines.
        ...
        PUBLIC   :: calc_similarity

        PRIVATE  :: calc_centroid
        PRIVATE  :: locate_mu_points
        PRIVATE  :: calc_mu_val

! Output subroutines.
        PUBLIC  :: output_similarity
...
!        PRINT *, 'mu_4', mu_4
        ...
        SUBROUTINE output_similarity
        USE initialise,     ONLY: output_file
        IMPLICIT NONE
        OPEN(30,file=output_file,access='append')
        WRITE(30,*) timestep, similarity
        CLOSE(30)
        END SUBROUTINE output_similarity
